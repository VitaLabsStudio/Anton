...
describe('LinguisticIntentAnalyzer', () => {
  ...
  const examples = [
    ...
    { text: "What actually works to stop a hangover headache fast?", expected: "high_solution", mockScore: 0.95 },
  ...
  it('should check Redis cache before API', async () => {
    ...
    const cachedResult = { score: 0.88, confidence: 0.99, category: "high_solution", reasoning: "Cached" };
